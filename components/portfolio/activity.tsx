...
export function Activity() {
  ...
  return (
    <section id="activity" className="bg-[#111111] py-20 lg:py-28 px-6 lg:px-20 text-white border-t border-white/10">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 id="act-title" className="font-display text-4xl sm:text-5xl font-extrabold tracking-tight mb-2">
        ...
        <p className="text-xs sm:text-sm text-slate-400 max-w-lg mb-8 leading-relaxed">
          Live contribution graphs, solved problems breakdown, and continuous activity metrics.
        </p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
          {topMetrics.map((m) => {
            const Content = (
              <div className="bg-[#161616] border border-white/10 rounded-xl p-4 flex flex-col justify-between hover:border-[#c8421a]/40 transition-all hover:-translate-y-1 h-full">
                <div>
