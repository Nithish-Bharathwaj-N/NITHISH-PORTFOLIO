...
<section id="intro" aria-label="Introduction">
  <div class="hero-copy">
    ...
    <div class="hero-btns">
      ...
      <a href="#contact" class="btn-ghost">Download CV ↓</a>
    </div>
  ...
  <div class="about-wrap">
    ...
    <div class="about-grid">
      <div class="about-photo-wrap fu">
        <img src="images/nithish-photo.jpg" alt="Portrait of Nithish Bharathwaj N" loading="lazy" width="320" height="427">
      </div>
      <div class="about-body">
        ...
        <div class="about-info">
          ...
          <div class="fu">
            ...
            <div class="info-item"><strong>Class XII — 88.4%</strong><span>Vidya Mandir Sr Sec School</span></div>
          </div>
          <div class="fu">
...
<section id="works" aria-labelledby="works-title">
  <div class="works-wrap">
    ...
    <div class="proj-grid" id="proj-grid">
      ...
      <article class="proj-card fu" data-cat="cybersecurity ai-ml">
        <div class="proj-thumb" style="background:linear-gradient(135deg,#0a0f1e 0%,#1a2744 100%);display:flex;align-items:center;justify-content:center"><span class="proj-badge">Cybersecurity</span><svg width="68" height="68" viewBox="0 0 24 24" style="opacity:0.45" aria-hidden="true"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z" fill="#c8421a"/></svg></div>
        <div class="proj-body"><div class="proj-name">SentinelX</div><div class="proj-sub">Threat Intelligence &amp; Log Analyzer</div><p class="proj-desc">Security telemetry platform for real-time threat detection, log parsing and incident visualization.</p><div class="proj-tech"><span>Python</span><span>FastAPI</span><span>SQLite</span><span>DKIM 2.0</span></div><div class="proj-actions"><a href="https://github.com/Nithish-Bharathwaj-N" target="_blank" rel="noopener" class="proj-btn proj-btn-case">Case Study →</a><a href="https://github.com/Nithish-Bharathwaj-N" target="_blank" rel="noopener" class="proj-btn proj-btn-live">Live Demo ↗</a></div></div>
      </article>
    </div>
