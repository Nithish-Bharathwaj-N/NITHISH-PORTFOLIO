...
<section id="activity" aria-labelledby="act-title">
  <div class="skills-wrap">
    ...
    <h2 id="act-title" class="sec-title" style="color:#fff">Coding <span style="color:var(--accent)">Activity &amp; Heatmaps.</span></h2>
    <p style="font-size:0.86rem;color:var(--text-muted);margin-top:8px;margin-bottom:32px;line-height:1.65;">Live contribution graphs, solved problems breakdown, and continuous activity metrics.</p>
