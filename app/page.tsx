...
/* SECTION 02 - ABOUT ME SCREENSHOT EXACT MATCH */
#about {
  background: #f7f6f2;
...
@media(max-width:1024px) { .about-exact-wrap { grid-template-columns: 1fr; gap: 44px; } }
...
@media(max-width:860px) { .about-drives-strip { padding: 32px 24px; } }
...
@media(max-width:1024px) { .about-drives-inner { grid-template-columns: 1fr; gap: 20px; } }
...
.drives-title span { color: #d9471f; }
...
/* ALIGN ABOUT SECTION FLUSH LEFT WITH NAVBAR */
#about {
  background: #f7f6f2;
  padding: 90px 48px 70px;
  position: relative;
...
@media(max-width:1024px) { .about-exact-wrap { grid-template-columns: 1fr; gap: 36px; } }
...
<!-- SECTION 02 - ABOUT ME EXACT SCREENSHOT MATCH -->
<section id="about" aria-labelledby="about-title">
  <div class="about-exact-wrap fu">
    <!-- LEFT SIDE - PROFILE PHOTO & CARDS -->
    <div class="about-left-col">
      <div class="about-photo-card">
        <img src="images/nithish-about.jpg" alt="Nithish Bharathwaj N Formal Suit Portrait">
      </div>
      ...
      <div class="about-info-list">
        <div class="about-info-row">
          ...
          <div class="about-info-text">
            ...
            <span>Cybersecurity • AI/ML • Full-Stack Engineer</span>
          </div>
        </div>
    ...
    <div class="about-right-col">
      ...
      <div class="about-prose">
        <p>
          I'm a second-year BE Cybersecurity student at <strong>Chennai Institute of Technology</strong>, driven by curiosity and a passion for solving real-world problems through technology.
        </p>
        <p>
      ...
      <div class="about-stats-grid">
        <div class="about-stat-col">
          ...
          <div class="about-stat-val" data-target="500" data-suffix="+">500+</div>
          <div class="about-stat-lbl">LeetCode<br>Problems Solved</div>
        </div>

        <div class="about-stat-col">
          <div class="about-stat-icon">🏆</div>
          <div class="about-stat-val" data-target="5" data-suffix="+">5+</div>
          <div class="about-stat-lbl">Hackathon<br>Finalist</div>
        </div>

        <div class="about-stat-col">
          <div class="about-stat-icon">🚀</div>
          <div class="about-stat-val" data-target="3" data-suffix="+">3+</div>
          <div class="about-stat-lbl">Major<br>Projects</div>
        </div>

        <div class="about-stat-col">
          <div class="about-stat-icon">🕒</div>
          <div class="about-stat-val">5–6 Hrs</div>
          <div class="about-stat-lbl">Daily<br>Learning</div>
        </div>
      </div>

      <div>
        <a href="#journey" class="about-journey-link">More about my journey →</a>
      </div>
    </div>
  </div>
</section>
...
<div class="about-drives-strip fu">
  <div class="about-drives-inner">
    ...
    <div class="drives-right-quote">
      <span class="drives-quote-mark">“</span>
      <p class="drives-quote-text">
