...
<section id="activity" aria-labelledby="act-title">
  <div class="ach-wrap">
    <div class="sec-label dark-lbl">06</div>
    <h2 id="act-title" class="sec-title">Coding <span style="color:var(--accent)">Activity &amp; Heatmaps.</span></h2>
    <p class="sec-subdesc">Live real-time contribution graphs, verified GitHub repositories, and LeetCode problem-solving activity.</p>

    <!-- 4 TOP METRIC CARDS WITH LIGHT THEME & REAL DATA -->
    <div class="ach-top-metrics" style="margin-bottom:28px;">
      <a href="https://leetcode.com/u/nithish_cit/" target="_blank" rel="noopener" class="light-metric-card" style="text-decoration:none;">
        <div>
          <div class="tm-icon-title">
            <div class="tm-icon">&lt;/&gt;</div>
            <div class="lmc-num">500+</div>
          </div>
          <div class="lmc-title">LeetCode Solved</div>
          <div class="lmc-sub">Across All Difficulty Levels</div>
        </div>
      ...
      <a href="https://leetcode.com/u/nithish_cit/" target="_blank" rel="noopener" class="light-metric-card" style="text-decoration:none;">
        <div>
          <div class="tm-icon-title">
            <div class="tm-icon">📈</div>
            <div class="lmc-num">1771</div>
          </div>
          <div class="lmc-title">Peak Contest Rating</div>
          <div class="lmc-sub">118-day Coding Streak</div>
        </div>
      ...
      <a href="https://github.com/Nithish-Bharathwaj-N" target="_blank" rel="noopener" class="light-metric-card" style="text-decoration:none;">
        <div>
          <div class="tm-icon-title">
            <div class="tm-icon">🐙</div>
            <div class="lmc-num">10</div>
          </div>
          <div class="lmc-title">Public Repositories</div>
          <div class="lmc-sub">GitHub @Nithish-Bharathwaj-N</div>
        </div>
      ...
      <a href="https://github.com/Nithish-Bharathwaj-N" target="_blank" rel="noopener" class="light-metric-card" style="text-decoration:none;">
        <div>
          <div class="tm-icon-title">
            <div class="tm-icon">⭐</div>
            <div class="lmc-num">15+</div>
          </div>
          <div class="lmc-title">Stars Earned</div>
          <div class="lmc-sub">Across Flagship Repos</div>
        </div>
    ...
    <!-- MIDDLE ROW: LEETCODE ACTIVITY & GITHUB ACTIVITY PANELS -->
    <div class="ach-main-grid fu">
      <!-- LEETCODE ACTIVITY PANEL (LIGHT THEME) -->
      <div class="light-activity-panel">
        <div class="light-panel-hdr">
          <div class="light-panel-title"><span style="color:#a855f7;">⚡</span> LEETCODE ACTIVITY</div>
          <a href="https://leetcode.com/u/nithish_cit/" target="_blank" rel="noopener" class="light-panel-link">@nithish_cit ↗</a>
        </div>

        <div class="leet-content-grid">
          <!-- LEFT SIDE REAL STATS -->
          <div class="leet-side-stats">
            <div class="light-leet-stat-item">
              <div class="light-lsi-val" style="color:#a855f7;">1771</div>
              <div class="light-lsi-lbl">Peak Rating</div>
              <div class="light-lsi-sub">Top 11.11% of users</div>
            </div>

            <div class="light-leet-stat-item">
              <div class="light-lsi-val" style="color:#f59e0b;">118 Days</div>
              <div class="light-lsi-lbl">Longest Streak</div>
              <div class="light-lsi-sub">Keep it consistent</div>
            </div>

            <div class="light-leet-stat-item">
              <div class="light-lsi-val">500+</div>
              <div class="light-lsi-lbl">Problems Solved</div>
              <div class="light-lsi-sub">All Difficulty Levels</div>
            </div>

            <div class="light-leet-stat-item">
              <div class="light-lsi-val" style="color:#10b981;">250+</div>
              <div class="light-lsi-lbl">Contest Participated</div>
              <div class="light-lsi-sub">Actively Improving</div>
            </div>
          </div>

          <!-- LEETCODE STATS CARD EMBED (LIGHT THEME) -->
          <div class="leet-card-embed">
            <img src="https://leetcard.jacoblin.cool/nithish_cit?theme=light&font=Space%20Grotesk&ext=heatmap" alt="LeetCode Activity Heatmap Card" loading="lazy">
          </div>
        </div>

        <!-- BREAKDOWN ROW -->
        <div class="leet-breakdown-row" style="border-top:1px solid #f1f5f9;">
          <div>
            <div style="font-size:0.68rem;font-weight:800;color:var(--text-dark-3);margin-bottom:6px;text-transform:uppercase;">Problems Solved by Difficulty</div>
            <div class="diff-pills">
              <div class="diff-pill-item" style="background:#f8fafc;color:var(--text-dark-2);"><span style="color:#10b981;font-weight:700;">• Easy</span><span>218 (43.6%)</span></div>
              <div class="diff-pill-item" style="background:#f8fafc;color:var(--text-dark-2);"><span style="color:#f59e0b;font-weight:700;">• Medium</span><span>225 (45.0%)</span></div>
              <div class="diff-pill-item" style="background:#f8fafc;color:var(--text-dark-2);"><span style="color:#ef4444;font-weight:700;">• Hard</span><span>57 (11.4%)</span></div>
            </div>
          </div>

          <div>
            <div style="font-size:0.68rem;font-weight:800;color:var(--text-dark-3);margin-bottom:6px;text-transform:uppercase;">Languages Used</div>
            <div class="lang-bars">
              <div class="lang-item">
                <div style="display:flex;justify-content:space-between;color:var(--text-dark-2);"><span>Python</span><span>78%</span></div>
                <div class="lang-bar-bg" style="background:#e2e8f0;"><div class="lang-bar-fill" style="width:78%;background:#a855f7;"></div></div>
              </div>
              <div class="lang-item">
                <div style="display:flex;justify-content:space-between;color:var(--text-dark-2);"><span>C++</span><span>15%</span></div>
                <div class="lang-bar-bg" style="background:#e2e8f0;"><div class="lang-bar-fill" style="width:15%;background:#3b82f6;"></div></div>
              </div>
              <div class="lang-item">
                <div style="display:flex;justify-content:space-between;color:var(--text-dark-2);"><span>JavaScript</span><span>7%</span></div>
                <div class="lang-bar-bg" style="background:#e2e8f0;"><div class="lang-bar-fill" style="width:7%;background:#f59e0b;"></div></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- GITHUB ACTIVITY PANEL (LIGHT THEME & REAL GITHUB DATA) -->
      <div class="light-activity-panel">
        <div class="light-panel-hdr">
          <div class="light-panel-title"><span style="color:#c8421a;">🐙</span> GITHUB ACTIVITY</div>
          <a href="https://github.com/Nithish-Bharathwaj-N" target="_blank" rel="noopener" class="light-panel-link">@Nithish-Bharathwaj-N ↗</a>
        </div>

        <!-- REAL GITHUB GREEN/ORANGE CONTRIBUTION HEATMAP GRAPH -->
        <div style="font-size:0.68rem;font-weight:800;color:var(--text-dark-3);margin-bottom:8px;text-transform:uppercase;">Contribution Graph</div>
        <div class="light-gh-chart-container">
          <img src="https://ghchart.rshah.org/c8421a/Nithish-Bharathwaj-N" alt="GitHub Live Contribution Graph" loading="lazy">
        </div>

        <!-- REAL GITHUB STATS BOXES GRID -->
        <div class="gh-stats-grid">
          <div class="light-gh-stat-box">
            <div class="light-ghs-num">10</div>
            <div class="light-ghs-lbl">Public Repos</div>
            <div class="light-ghs-sub">Verified API</div>
          </div>

          <div class="light-ghstat-box light-gh-stat-box">
            <div class="light-ghs-num">250+</div>
            <div class="light-ghs-lbl">Commits</div>
            <div class="light-ghs-sub">Active Dev</div>
          </div>

          <div class="light-gh-stat-box">
            <div class="light-ghs-num">12</div>
            <div class="light-ghs-lbl">Pull Requests</div>
            <div class="light-ghs-sub">Merged</div>
          </div>

          <div class="light-gh-stat-box">
            <div class="light-ghs-num">15+</div>
            <div class="light-ghs-lbl">Stars Earned</div>
            <div class="light-ghs-sub">SubAERO &amp; AI</div>
          </div>

          <div class="light-gh-stat-box">
            <div class="light-ghs-num">1.5K+</div>
            <div class="light-ghs-lbl">Profile Views</div>
            <div class="light-ghs-sub">Real Metrics</div>
          </div>
        </div>
      </div>
    </div>
