...
/* SECTION 02 - ABOUT ME MOCKUP 100% EXACT MATCH */
#about {
  background: #fbfaf7;
...
@media(max-width:1024px) { .about-top-grid { grid-template-columns: 1fr; gap: 36px; } }
...
.about-quote-card {
  background: #fdf8f6;
  border: 1px solid rgba(217,71,31,0.12);
  border-radius: 14px;
  padding: 18px 20px;
  display: flex;
  align-items: flex-start;
...
@media(max-width:860px) { .about-three-cards { grid-template-columns: 1fr; } }
...
.a-card-box:hover {
  border-color: rgba(217,71,31,0.3);
  transform: translateY(-3px);
...
.a-card-icon {
  ...
  height: 36px;
  border-radius: 8px;
  background: rgba(217,71,31,0.08);
  display: flex;
  align-items: center;
  justify-content: center;
  font-size: 1.15rem;
...
.about-bottom-banner {
  background: #fdfbf7;
  border: 1px solid rgba(217,71,31,0.18);
  border-radius: 18px;
  padding: 28px 36px;
  display: flex;
  align-items: center;
  justify-content: space-between;
  box-shadow: 0 8px 28px rgba(217,71,31,0.05);
}
@media(max-width:860px) { .about-bottom-banner { flex-direction: column; gap: 20px; text-align: center; padding: 24px; } }
...
@media(max-width:860px) { .b-banner-right { align-items: center; } }
...
/* SECTION 03 - EXPERTISE & TECHNOLOGY SCREENSHOT EXACT MATCH */
#skills {
  background: #0d0d0d;
  padding: 90px 48px 70px;
  position: relative;
...
@media(max-width:860px) { #skills { padding: 60px 20px 40px; } }
...
@media(max-width:1100px) { .skills-top-layout { grid-template-columns: 1fr; gap: 32px; } }
...
.skills-left-bottom-row {
  display: flex;
  align-items: center;
  gap: 24px;
}
@media(max-width:640px) { .skills-left-bottom-row { flex-direction: column; align-items: flex-start; } }
...
.view-tech-btn {
  ...
  border-radius: 8px;
  background: rgba(255,255,255,0.03);
  border: 1px solid rgba(217,71,31,0.4);
  font-size: 0.78rem;
  font-weight: 800;
  color: #ffffff;
...
@media(max-width:1280px) { .skills-4cards-grid { grid-template-columns: repeat(2, 1fr); } }
@media(max-width:640px) { .skills-4cards-grid { grid-template-columns: 1fr; } }
...
.domain-column-card:hover {
  border-color: rgba(217,71,31,0.35);
  transform: translateY(-4px);
  box-shadow: 0 14px 32px rgba(0,0,0,0.4);
}
...
.d-circle-icon {
  ...
  height: 44px;
  border-radius: 50%;
  background: rgba(217,71,31,0.1);
  border: 1px solid rgba(217,71,31,0.25);
  display: flex;
  align-items: center;
  justify-content: center;
  font-size: 1.25rem;
...
@media(max-width:680px) { .tech-stack-card { padding: 24px; } }
...
@media(max-width:1100px) { .tech-categories-grid { grid-template-columns: repeat(2, 1fr); } }
@media(max-width:640px) { .tech-categories-grid { grid-template-columns: 1fr; } }
...
.t-chip:hover {
  border-color: #d9471f;
  color: #ffffff;
  background: rgba(217,71,31,0.12);
}
...
@media(max-width:1100px) { .principles-card { grid-template-columns: 1fr; gap: 20px; } }
...
@media(max-width:1100px) { .p-items-grid { grid-template-columns: repeat(3, 1fr); } }
@media(max-width:640px) { .p-items-grid { grid-template-columns: 1fr; } }
...
/* SECTION 05 - ACHIEVEMENTS SCREENSHOT EXACT MATCH */
#achievements {
  background: #0d0d0d;
  padding: 90px 48px 70px;
  position: relative;
...
@media(max-width:860px) { #achievements { padding: 60px 20px 40px; } }
...
@media(max-width:1280px) { .ach-top-grid { grid-template-columns: 1fr; } }
...
.ach-feat-card {
  background: #131317;
  border: 1px solid rgba(217,71,31,0.28);
  border-radius: 18px;
  padding: 24px 28px;
  display: grid;
...
@media(max-width:768px) { .ach-feat-card { grid-template-columns: 1fr; } }
...
.ach-feat-sub span { color: rgba(255,255,255,0.6); }
...
@media(max-width:1280px) { .hackathons-grid { grid-template-columns: repeat(3, 1fr); } }
@media(max-width:640px) { .hackathons-grid { grid-template-columns: 1fr; } }
...
.h-card-node.highlight-node {
  border-color: rgba(217,71,31,0.5);
  background: rgba(217,71,31,0.05);
}
.h-card-node:hover {
  border-color: #d9471f;
  transform: translateY(-3px);
...
@media(max-width:1100px) { .j-steps-grid { grid-template-columns: repeat(3, 1fr); } }
@media(max-width:640px) { .j-steps-grid { grid-template-columns: 1fr; } }
...
.j-step-icon {
  ...
  border-radius: 50%;
  background: rgba(217,71,31,0.1);
  border: 1px solid rgba(217,71,31,0.3);
  display: flex;
  align-items: center;
  justify-content: center;
  font-size: 0.95rem;
...
@media(max-width:860px) { .ach-quote-banner { flex-direction: column; gap: 16px; text-align: center; } }
...
@media(max-width:860px) { .ach-q-right { align-items: center; } }
...
<!-- SECTION 02 - ABOUT ME 100% EXACT MOCKUP MATCH -->
<section id="about" aria-labelledby="about-title">
  <div class="about-exact-container fu">
    ...
    <div class="about-top-grid">
      ...
      <div class="about-right-content">
        <div class="about-tag-lbl">ABOUT ME</div>
        <h2 id="about-title" class="about-headline">
          THE PERSON BEHIND<br>
          THE <span>SYSTEMS.</span>
        </h2>
        ...
        <div class="about-text-prose">
          ...
          <p>
            I enjoy building <strong>secure, intelligent</strong> and <strong>real-time systems</strong> at the intersection of cybersecurity, AI and full-stack development.
          </p>
          <p>
            <strong>I learn by doing</strong> — from competitive programming and security research to AI experiments and engineering impactful applications.
          </p>
        </div>

        <!-- 3 CARDS BELOW PARAGRAPHS -->
        <div class="about-three-cards">
          <!-- CARD 01 -->
          ...
          <div class="a-card-box">
            <div class="a-card-header">
              ...
              <div class="a-card-meta">
                <span class="a-card-num">02</span>
                <span class="a-card-title">WHAT I BUILD</span>
              </div>
            </div>
            <div class="a-card-line"></div>
            <ul class="a-card-ul">
          ...
          <div class="a-card-box">
            ...
            <div class="a-card-line"></div>
            <ul class="a-card-ul">
              <li>Difficult Problems</li>
              <li>Continuous Learning</li>
              <li>Building in Public</li>
              <li>Research & Curiosity</li>
              <li>Discipline & Consistency</li>
              <li>Creating Real Impact</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="about-bottom-banner">
      <div class="b-banner-left">
        <span class="b-banner-quote-mark">“</span>
        <div class="b-banner-text">
          I believe in learning deeply, building consistently,<br>
          and creating solutions that make a <strong>real difference.</strong>
        </div>
      </div>

      <div class="b-banner-right">
        <div class="b-signature">Nithish</div>
        <div class="b-signature-sub">KEEP LEARNING. KEEP BUILDING.</div>
      </div>
    </div>
  </div>
</section>
...
<!-- SECTION 03 - EXPERTISE & TECHNOLOGY 100% EXACT MOCKUP MATCH -->
<section id="skills" aria-labelledby="skills-title">
  <div class="skills-mockup-wrap fu">
    <!-- TOP LAYOUT: LEFT HEADER & RIGHT 4 CARDS -->
    <div class="skills-top-layout">
      <!-- LEFT HEADER -->
      <div class="skills-left-header">
        <div class="skills-tag-line">EXPERTISE & TECHNOLOGY</div>
        <h2 id="skills-title" class="skills-main-title">
          WHAT I KNOW.<br>
          WHAT I <span>BUILD</span> WITH.
        </h2>
        <p class="skills-narrative">
        ...
        <div class="skills-left-bottom-row">
          ...
          <div class="skills-mini-stats">
            <div class="mini-stat-item">
              ...
              <div class="mini-stat-lbl">TECHNOLOGIES</div>
            </div>
            <div class="mini-stat-item">
              <div class="mini-stat-num">5</div>
              <div class="mini-stat-lbl">CORE DOMAINS</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="skills-4cards-grid">
        ...
        <div class="domain-column-card">
          ...
          <span class="d-num-tag">03</span>
          <h3 class="d-card-title">FULL-STACK ENGINEERING</h3>
          <p class="d-card-sub">Build robust. Ship fast. Scale endlessly.</p>
          <div class="d-card-divider"></div>
          <ul class="d-card-ul">
            <li>React / Next.js</li>
    ...
    <div class="tech-stack-card">
      <div class="tech-stack-hdr">TECH STACK <span>•</span></div>

      <div class="tech-categories-grid">
        <!-- ROW 1 -->
        <div class="t-cat-group">
          <div class="t-cat-lbl"><span>&lt;/&gt;</span> LANGUAGES</div>
          <div class="t-chips-flex">
            <span class="t-chip">Python</span>
            <span class="t-chip">TypeScript</span>
            <span class="t-chip">JavaScript</span>
            <span class="t-chip">C++</span>
            <span class="t-chip">SQL</span>
          </div>
        </div>
        ...
        <div class="t-cat-group">
          ...
          <div class="t-chips-flex">
            ...
            <span class="t-chip">FastAPI</span>
            <span class="t-chip">Node.js</span>
            <span class="t-chip">Express</span>
          </div>
        </div>
        ...
        <div class="t-cat-group">
          ...
          <div class="t-chips-flex">
            ...
            <span class="t-chip">MySQL</span>
            <span class="t-chip">Redis</span>
          </div>
        </div>
        ...
        <div class="t-cat-group">
          ...
          <div class="t-chips-flex">
            ...
            <span class="t-chip">RAG</span>
            <span class="t-chip">AI Agents</span>
            <span class="t-chip">ML</span>
          </div>
        </div>
        ...
        <div class="t-cat-group">
          ...
          <div class="t-chips-flex">
            ...
            <span class="t-chip">Linux</span>
            <span class="t-chip">Nginx</span>
            <span class="t-chip">GitHub Actions</span>
          </div>
        </div>
        ...
        <div class="t-cat-group">
          ...
          <div class="t-chips-flex">
            ...
            <span class="t-chip">Figma</span>
            <span class="t-chip">Jupyter</span>
            <span class="t-chip">Unity</span>
          </div>
        </div>
        ...
        <div class="t-cat-group">
          ...
          <div class="t-chips-flex">
            ...
            <span class="t-chip">Kafka</span>
            <span class="t-chip">Redis Streams</span>
          </div>
        </div>
        ...
        <div class="t-cat-group">
          ...
          <div class="t-chips-flex">
            ...
            <span class="t-chip">DSA</span>
            <span class="t-chip">Linux Scripting</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="principles-card">
      <div class="p-left-hdr">
        <div class="p-left-title">&gt;_ ENGINEERING PRINCIPLES I LIVE BY</div>
      </div>
      ...
      <div class="p-items-grid">
        ...
        <div class="p-col-item">
          ...
          <div class="p-col-title">CLEAN & MAINTAINABLE</div>
          <div class="p-col-desc">Clean code, modular architecture and continuous improvement.</div>
        </div>
...
<!-- SECTION 05 - ACHIEVEMENTS 100% EXACT MOCKUP MATCH -->
<section id="achievements" aria-labelledby="ach-title">
  <div class="ach-mockup-wrap fu">
    <!-- TOP ROW: LEFT HEADER, MIDDLE FEATURED CARD, RIGHT SIDEBAR -->
    <div class="ach-top-grid">
      <!-- LEFT HEADER -->
      <div class="ach-left-hdr">
        <div class="ach-tag-lbl">ACHIEVEMENTS</div>
        <h2 id="ach-title" class="ach-main-title">
          PROOF OF WORK.<br>
          <span>MILESTONES</span> THAT MATTER.
        </h2>
      ...
      <div class="ach-feat-card">
        <div>
          ...
          <a href="#works" class="ach-feat-btn">View Project Case Study →</a>
        </div>

        <div>
          <img src="images/subaero-preview.jpg" alt="Aerothon 2026 Digital Twin" class="ach-feat-img">
        </div>
      </div>

      <!-- RIGHT SIDEBAR STATS -->
      <div class="ach-side-stats">
        <div class="ach-stat-row">
          <span class="ach-stat-icon">&lt;/&gt;</span>
          <div>
            <div class="ach-stat-num">500+</div>
            <div class="ach-stat-lbl">LeetCode Problems Solved</div>
            <div class="ach-stat-sub">Across All Difficulty Levels</div>
          </div>
        </div>
        ...
        <div class="ach-stat-row">
          ...
          <div>
            ...
            <div class="ach-stat-sub">118-Day Coding Streak</div>
          </div>
        </div>
        ...
        <div class="ach-stat-row">
          ...
          <div>
            ...
            <div class="ach-stat-sub">250+ Commits</div>
          </div>
        </div>
        ...
        <div class="ach-stat-row">
          ...
          <div>
            ...
            <div class="ach-stat-sub">National Level Competitions</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- MIDDLE CARD: HACKATHON & COMPETITIONS HORIZONTAL TIMELINE -->
    <div class="hackathons-card">
      <div class="hackathons-hdr">HACKATHON &amp; COMPETITIONS <span>•</span></div>
      ...
      <div class="hackathons-grid">
        ...
        <div class="h-card-node highlight-node">
          ...
          <div class="h-year-tag">2026</div>
        </div>

        <!-- NODE 2: HACKDRIVEN 2026 (USER REQUESTED!) -->
        <div class="h-card-node highlight-node">
          <div class="h-icon-box">⚡</div>
          <div class="h-name">HackDriven 2026</div>
        ...
        <div class="h-card-node">
          <div class="h-icon-box">&lt;/&gt;</div>
          <div class="h-name">Codeathon 2025</div>
          <div class="h-badge">FINALIST</div>
          <div class="h-org">National Level Hackathon</div>
          <div class="h-year-tag">2025</div>
        </div>
    ...
    <!-- LOWER CARD: JOURNEY TIMELINE -->
    <div class="j-timeline-card">
      <div class="j-timeline-hdr">JOURNEY TIMELINE <span>•</span></div>

      <div class="j-steps-grid">
        <div class="j-step-item">
          <div class="j-step-top">
            <div class="j-step-icon">&lt;/&gt;</div>
            <div class="j-step-year">Mid 2025</div>
          </div>
          <div class="j-step-title">Competitive Programming</div>
          <div class="j-step-desc">Building problem solving skills and algorithm foundations.</div>
        </div>
        ...
        <div class="j-step-item">
          ...
          <div class="j-step-desc">Explored security fundamentals, networking and ethical hacking.</div>
        </div>

        <div class="j-step-item">
          <div class="j-step-top">
            <div class="j-step-icon">&lt;/&gt;</div>
            <div class="j-step-year">Early 2026</div>
          </div>
          <div class="j-step-title">Full-Stack Development</div>
          <div class="j-step-desc">Started building end-to-end web applications and real-time systems.</div>
        </div>
        ...
        <div class="j-step-item">
          ...
          <div class="j-step-desc">Dived into ML models, LLMs, agents and intelligent systems.</div>
        </div>
        ...
        <div class="j-step-item">
          ...
          <div class="j-step-desc">Working on ambitious projects and participating in real-world hackathons.</div>
        </div>
      </div>
    </div>

    <!-- BOTTOM QUOTE BANNER -->
    <div class="ach-quote-banner">
      <div class="ach-q-left">
        <span class="ach-q-mark">“</span>
        <div class="ach-q-text">
          Achievements are not just wins, they are the <strong>lessons</strong> that shape what's next.
        </div>
      </div>

      <div class="ach-q-right">
        <div class="ach-sig">Nithish</div>
        <div class="ach-sig-sub">KEEP LEARNING. KEEP BUILDING. KEEP IMPACTING.</div>
      </div>
    </div>
  </div>
</section>
